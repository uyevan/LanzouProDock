...
pidfile = '/www/wwwroot/LanzouAPI/gunicorn.pid'

# 设置访问日志和错误信息日志路径
accesslog = '/www/wwwlogs/python/LanzouAPI/gunicorn_acess.log'
errorlog = '/www/wwwlogs/python/LanzouAPI/gunicorn_error.log'
